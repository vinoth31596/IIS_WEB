...
function action_trigger() {
    ...
    $.ajax({
        url: `http://18.224.228.104:5005/conversations/${user_id}/execute`,
        type: "POST",
...
function send(message) {
    ...
    $.ajax({
        url: "http://18.224.228.104:5005/webhooks/rest/webhook",
        type: "POST",
        contentType: "application/json",
...
function setBotResponse(response) {
    ...
    setTimeout(function() {
        ...
        if (response.length < 1) {
            ...
            var BotResponse = '<img class="botAvatar" src="./static/img/sara_avatar.jpg"/><p class="botMsg">' + fallbackMsg + '</p><div class="clearfix"></div>';
            ...
            for (i = 0; i < response.length; i++) {
                ...
                if (response[i].hasOwnProperty("text")) {
                    var BotResponse = '<img class="botAvatar" src="./static/img/sara_avatar.jpg"/><p class="botMsg">' + response[i].text + '</p><div class="clearfix"></div>';
                    $(BotResponse).appendTo(".chats").hide().fadeIn(1000);
                }
...
function showBotTyping() {
    ...
    var botTyping = '<img class="botAvatar" id="botAvatar" src="./static/img/sara_avatar.jpg"/><div class="botTyping">' + '<div class="bounce1"></div>' + '<div class="bounce2"></div>' + '<div class="bounce3"></div>' + '</div>'
